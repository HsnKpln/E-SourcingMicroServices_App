...
namespace E_SourcingMicroServices
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddTransient<IProductContext,ProductContext>();  //neden ayrý ayrý data oluþturduk sadece productContext den ya da sadece productRepository den ürünlere eriþsek olmaz mýydý?
